...
class Monster(animation.AnimateSprite):
    ...
    def damage(self,amount):
        ...
        if self.health <= 0:
            ...
            # Ajouter un nb de pts au score
            self.game.add_score(self.loot_amount)

            # Si la barre d'evenement est chargée
    ...
    def update_health_bar(self, surface):
        ...
        pygame.draw.rect(surface, (60,63,60), [self.rect.x +20, self.rect.y -20, self.max_health, 5])
        pygame.draw.rect(surface, (111,210,46),[self.rect.x +20, self.rect.y -20, self.health, 5])


    def forward(self):
        # Le deplacement ne se fait que s'il n'y a pas de collision avec un joueur
